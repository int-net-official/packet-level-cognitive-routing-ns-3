...
```bash
git clone https://github.com/int-net-official/packet-level-cognitive-routing-ns-3
```

by default, source code will be download into ./packet-level-cognitive-routing-ns-3 folder.
...
**Notice**: the version the protobuf is 3.6 if you download this way.   The c++ file compiled will change at after version 3.7. Potential error will explain later.
...
2. Use git to install **ns-3-dev**  
   ...
   *You can also install a specific version od ns-3, such as ns-3.30. Please notice that the version of ns3 should no more than 3.36* 
